    ...
    <div className="pt-20 flex flex-col">
      ...
      <section className="relative py-16 md:py-28 dotted-background">
        <div className="max-w-4xl m-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 gradient-title">Find Your Luxury Cars With Ariib Autos </h1>
            <p className="text-2xl text-gray-200 mb-8 max-w-2xl mx-auto">
              Advanced AI Car Search and test drive from thousands of vehicles all over Nigeria <span></span>
            </p>
          </div>
          {/*Search*/}
          <HomeSearch />
